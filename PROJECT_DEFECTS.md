...
هذا السجل يحتوي **عيوبًا مؤكدة فقط**. المخاطر غير المثبتة والمناطق التي تحتاج بيئة خارجية موجودة في `docs/archive/FULL_PROJECT_AUDIT.md` ولا تُعرض هنا كأخطاء مؤكدة.
