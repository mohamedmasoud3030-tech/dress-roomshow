...
- [ ] **IN PROGRESS — 1.04:** Register appointments, sales invoices, sale returns, service tasks, audit, preferences, images, and every UI-created entity.
  - Evidence: PR #86 (in progress), registered all operational collections inside `@engines/persistence/collectionRegistry.ts`.
- [ ] **NEXT — 1.05:** Add transaction/snapshot primitives used by migrations, backup, restore, reset, and later workflow commands.
...
| Phase 1.04 register operational collections | PR #86 (in progress) | Build + Verify | Register appointments, sales invoices, returns, service tasks, audit, and images | In Progress |
