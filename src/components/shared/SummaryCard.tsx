...
export function SummaryCard({ label, value, hint, valueClassName, className }: SummaryCardProps) {
  return (
    <article className={`rounded-2xl border border-[#E8DED2] bg-white p-5 shadow-sm ${className ?? ''}`}>
