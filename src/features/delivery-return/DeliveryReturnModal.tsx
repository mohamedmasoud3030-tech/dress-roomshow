...
type Form = { operation: Operation; reservationNumber: string; dateTime: string; condition: string; lateFee: string; damageFee: string; refundMethod: PaymentMethod; nextDressStatus: 'available' | 'laundry' | 'maintenance' | 'damaged'; notes: string };
...
function defaults(): Form { return { operation: 'delivery', reservationNumber: '', dateTime: '', condition: '', lateFee: '0', damageFee: '0', refundMethod: 'cash', nextDressStatus: 'laundry', notes: '' }; }
  ...
  const submit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const record = form.operation === 'delivery'
        ...
        : completeReturn({ reservationNumber: form.reservationNumber, returnDateTime: form.dateTime, returnCondition: form.condition, lateFee: Number(form.lateFee), damageFee: Number(form.damageFee), refundMethod: form.refundMethod, nextDressStatus: form.nextDressStatus, notes: form.notes });
