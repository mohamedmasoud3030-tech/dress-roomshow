...
export function printSaleInvoice(invoice: SaleInvoice): void {
  try {
    ...
    if (!popup) throw new PrintSaleInvoiceError('تعذر فتح نافذة الطباعة. اسمحي بالنوافذ المنبثقة ثم أعيدي المحاولة.');
