...
export const landingShowroomProfile: LandingShowroomProfile = {
  ...
  aboutTitle: 'من نحن',
  aboutDescription:
    'نحن معرض متخصص في فساتين المناسبات وملحقاتها، نهتم بأن تجد العميلة الإطلالة المناسبة بسهولة ووضوح قبل الموعد. نعرض المتاح حاليًا، ونوضح الفئات والخدمات، ثم نوجّه العميلة إلى زيارة منظمة داخل المعرض للمعاينة أو الشراء أو التجربة.',
  categories: [
  ...
  faq: [
    ...
    {
      question: 'هل يمكن التأكيد بدون زيارة المعرض؟',
